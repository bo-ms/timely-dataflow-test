...
fn delay() {
    ...
    // https://docs.rs/timely/latest/timely/dataflow/operators/delay/trait.Delay.html#required-methods
    ...
    // Initialize the Timely Dataflow computation.
    timely::execute_directly(|worker| {
        ...
        worker.dataflow(|scope| {
            ...
            concatenated_stream
                ...
                .inspect(|x| println!("delayed output: {:?}", x));
        });
